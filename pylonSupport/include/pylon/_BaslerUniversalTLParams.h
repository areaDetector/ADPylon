...
namespace Basler_UniversalTLParams
{
    ...
    {
        OverflowEventSelect_All,  //!< All - Applies to: CoaXPress
        OverflowEventSelect_Incomplete,  //!< Incomplete - Applies to: CoaXPress
        OverflowEventSelect_IncompleteLost,  //!< IncompleteLost - Applies to: CoaXPress
        OverflowEventSelect_IncompleteOK,  //!< IncompleteOK - Applies to: CoaXPress
        OverflowEventSelect_Lost,  //!< Lost - Applies to: CoaXPress
        OverflowEventSelect_LostOK,  //!< LostOK - Applies to: CoaXPress
        OverflowEventSelect_OK  //!< OK - Applies to: CoaXPress
    };
    ...
    {
        VantagePoint_BottomLeft,  //!< Starting point of the image is the bottom left corner - Applies to: CoaXPress
        VantagePoint_BottomRight,  //!< Starting point of the image is the bottom right corner - Applies to: CoaXPress
        VantagePoint_TopLeft,  //!< Starting point of the image is the top left corner - Applies to: CoaXPress
        VantagePoint_TopRight  //!< Starting point of the image is the top right corner - Applies to: CoaXPress
    };
    ...
    public:
        ...
        */
        ...
        /*!
            ...
            The <a href="https://docs.baslerweb.com/?rhcsh=1&rhmapid=CxpTriggerPacketMode" target="_blank">feature documentation</a> may provide more information.
        */
        ...
        */
        ...
        //@{
        /*!
            \brief Select the content of the overflow event - Applies to: CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Set the threshold for generating a queue fill level OFF event - Applies to: CoaXPress

            Set the threshold for generating a queue fill level OFF event.
        ...
        */
        ...
        //@{
        /*!
            \brief Set the threshold for generating a queue fill level ON event - Applies to: CoaXPress

            Set the threshold for generating a queue fill level ON event.
        ...
        */
        ...
        //@{
        /*!
            \brief Choose vantage point for horizontal and/or vertical mirroring - Applies to: CoaXPress
