...
namespace Basler_UniversalCameraParams
{
    ...
    {
        AcquisitionMode_Continuous,  //!< The acquisition mode is set to Continuous - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        AcquisitionMode_MultiFrame,  //!< The acquisition mode is set to Multi Frame - Applies to: CameraLink and GigE
        AcquisitionMode_SingleFrame  //!< The acquisition mode is set to Single Frame - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    enum AutoFunctionProfileEnums
    {
        ...
        AutoFunctionProfile_MinimizeExposureTime,  //!< Exposure time is kept as low as possible - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        AutoFunctionProfile_MinimizeGain,  //!< Gain is kept as low as possible - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    ...
    {
        AutoFunctionROISelector_ROI1,  //!< Auto function ROI 1 can be configured - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        AutoFunctionROISelector_ROI2  //!< Auto function ROI 2 can be configured - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        BalanceRatioSelector_Blue,  //!< Balance ratio is applied to the blue channel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        BalanceRatioSelector_Green,  //!< Balance ratio is applied to the green channel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        BalanceRatioSelector_Red  //!< Balance ratio is applied to the red channel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    {
        BinningHorizontalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        BinningHorizontalMode_Sum  //!< The values of the binned pixels are summed - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        BinningSelector_Region1,  //!< FPGA binning can be configured - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        BinningSelector_Sensor  //!< Sensor binning can be configured - Applies to: boost CoaXPress
    };

    //! Valid values for BinningVerticalMode
    enum BinningVerticalModeEnums
    {
        BinningVerticalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        BinningVerticalMode_Sum  //!< The values of the binned pixels are summed - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };

    //! Valid values for BlackLevelSelector
    enum BlackLevelSelectorEnums
    {
        BlackLevelSelector_All,  //!< The black level value is applied to all sensor taps - Applies to: CameraLink, GigE, ace USB, dart USB and pulse USB
    ...
    {
        BslColorSpace_Off,  //!< No additional gamma correction value is applied - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        BslColorSpace_sRgb  //!< The color space is set to sRGB - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    };
    ...
    {
        BslContrastMode_Linear,  //!< The camera uses a linear function to adjust the contrast - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        BslContrastMode_SCurve  //!< The camera uses an S-curve function to adjust the contrast - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    enum BslLightSourcePresetEnums
    {
        ...
        BslLightSourcePreset_Daylight5000K,  //!< The light source preset for image acquisitions with daylight of 5000 K is selected - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        BslLightSourcePreset_Daylight6500K,  //!< The light source preset for image acquisitions with daylight of 6500 K is selected - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        BslLightSourcePreset_FactoryLED6000K,  //!< The light source preset for image acquisitions with LED light is selected - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        BslLightSourcePreset_Off,  //!< No light source preset is selected - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    ...
    {
        BslLineConnection_ConnectionOff,  //!< No connection signal is set for the currently selected line - Applies to: dart 2 USB
        BslLineConnection_TwiScl,  //!< The TWI SCL signal is set for the currently selected line - Applies to: dart 2 USB
        BslLineConnection_TwiSda  //!< The TWI SDA signal is set for the currently selected line - Applies to: dart 2 USB
    };
    ...
    {
        BslSensorState_Off,  //!< The sensor power is switched off - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        BslSensorState_On,  //!< The sensor power is switched on - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        BslSensorState_Standby  //!< The sensor is in standby mode - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    };
    ...
    {
        BslTemperatureStatus_Critical,  //!< The temperature is close to or at the allowed maximum  Provide cooling - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        BslTemperatureStatus_Error,  //!< The temperature is above the allowed maximum  Provide cooling immediately - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        BslTemperatureStatus_Ok  //!< The temperature is within the normal operating temperature range - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    };

    //! Valid values for BslTransferBitDepth
    enum BslTransferBitDepthEnums
    {
        BslTransferBitDepth_Bpp10,  //!< The transfer bit depth is set to 10 bits per pixel - Applies to: boost CoaXPress
        BslTransferBitDepth_Bpp12,  //!< The transfer bit depth is set to 12 bits per pixel - Applies to: boost CoaXPress
        BslTransferBitDepth_Bpp8  //!< The transfer bit depth is set to 8 bits per pixel - Applies to: boost CoaXPress
    };

    //! Valid values for BslTransferBitDepthMode
    enum BslTransferBitDepthModeEnums
    {
        BslTransferBitDepthMode_Auto,  //!< The transfer bit depth mode is set to Auto - Applies to: boost CoaXPress
        BslTransferBitDepthMode_Manual  //!< The transfer bit depth mode is set to Manual - Applies to: boost CoaXPress
    };

    //! Valid values for BslTwiBitrate
    enum BslTwiBitrateEnums
    {
        BslTwiBitrate_Bitrate100kbps,  //!< The bit rate is set to 100000 bits per second - Applies to: dart 2 USB
        BslTwiBitrate_Bitrate10kbps,  //!< The bit rate is set to 10000 bits per second - Applies to: dart 2 USB
        BslTwiBitrate_Bitrate200kbps,  //!< The bit rate is set to 200000 bits per second - Applies to: dart 2 USB
        BslTwiBitrate_Bitrate20kbps,  //!< The bit rate is set to 20000 bits per second - Applies to: dart 2 USB
        BslTwiBitrate_Bitrate400kbps,  //!< The bit rate is set to 400000 bits per second - Applies to: dart 2 USB
        BslTwiBitrate_Bitrate50kbps  //!< The bit rate is set to 50000 bits per second - Applies to: dart 2 USB
    };

    //! Valid values for BslTwiTransferStatus
    enum BslTwiTransferStatusEnums
    {
        BslTwiTransferStatus_NakAddress,  //!< The last transfer failed because a NAK was received when sending the address - Applies to: dart 2 USB
        BslTwiTransferStatus_NakData,  //!< The last transfer failed because a NAK was received when sending data - Applies to: dart 2 USB
        BslTwiTransferStatus_Pending,  //!< A transfer is pending - Applies to: dart 2 USB
        BslTwiTransferStatus_Success  //!< The last transfer was successful - Applies to: dart 2 USB
    };

    //! Valid values for BslUSBPowerSource
    enum BslUSBPowerSourceEnums
    {
        BslUSBPowerSource_Aux,  //!< Power is supplied via the I/O connector - Applies to: ace 2 USB
        BslUSBPowerSource_Bus  //!< Power is supplied via the bus - Applies to: ace 2 USB
    };
    ...
    {
        ChunkSelector_AutoBrightnessStatus,  //!< The Auto Brightness Status chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ChunkSelector_BrightPixel,  //!< Applies to: GigE
        ChunkSelector_CounterValue,  //!< The Counter Value chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        ChunkSelector_ExposureTime,  //!< The Exposure Time chunk can be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ChunkSelector_FrameID,  //!< The Frame ID chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        ChunkSelector_Gain,  //!< The Gain chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        ChunkSelector_LineStatusAll,  //!< The Line Status All chunk can be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
    ...
    enum CounterEventSourceEnums
    {
        ...
        CounterEventSource_ExposureStart,  //!< The selected counter counts the number of Exposure Start signals - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    ...
    enum CounterResetSourceEnums
    {
        ...
        CounterResetSource_Counter2End,  //!< The selected counter can be reset by a Counter End 2 signal - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        CounterResetSource_ExposureStart,  //!< The selected counter can be reset by an Exposure Start signal - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    ...
    enum CounterTriggerSourceEnums
    {
        ...
        CounterTriggerSource_ExposureStart,  //!< The selected counter can be started by an Exposure Start signal - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    ...
    enum CxpLinkConfigurationPreferredEnums
    {
        ...
        CxpLinkConfigurationPreferred_CXP10_X2,  //!< The link configuration is set to 2 connections operating at CXP-10 speed (10 Gbps) - Applies to: boost CoaXPress
        ...
        CxpLinkConfigurationPreferred_CXP12_X2,  //!< The link configuration is set to 2 connections operating at CXP-12 speed (12 5 Gbps) - Applies to: boost CoaXPress
        ...
        CxpLinkConfigurationPreferred_CXP2_X2,  //!< The link configuration is set to 2 connections operating at CXP-2 speed (2 5 Gbps) - Applies to: boost CoaXPress
        ...
        CxpLinkConfigurationPreferred_CXP3_X2,  //!< The link configuration is set to 2 connections operating at CXP-3 speed (3 125 Gbps) - Applies to: boost CoaXPress
        ...
        CxpLinkConfigurationPreferred_CXP5_X2,  //!< The link configuration is set to 2 connections operating at CXP-5 speed (5 Gbps) - Applies to: boost CoaXPress
        ...
        CxpLinkConfigurationPreferred_CXP6_X2  //!< The link configuration is set to 2 connections operating at CXP-6 speed (6 25 Gbps) - Applies to: boost CoaXPress
    };
    ...
    {
        DeviceCharacterSet_UTF8  //!< The strings of the device's bootstrap registers use the UTF-8 character set - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    };

    //! Valid values for DeviceIndicatorMode
    enum DeviceIndicatorModeEnums
    {
        DeviceIndicatorMode_Active,  //!< The status LED of the camera is turned on - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        DeviceIndicatorMode_Inactive  //!< The status LED of the camera is turned off - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart USB
    };
    ...
    {
        DeviceRegistersEndianness_Big,  //!< The endianness of the device's registers is big-endian - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        DeviceRegistersEndianness_Little  //!< The endianness of the device's registers is little-endian - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    };

    //! Valid values for DeviceScanType
    enum DeviceScanTypeEnums
    {
        DeviceScanType_Areascan,  //!< The camera has an area scan sensor - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        DeviceScanType_Areascan3D,  //!< Device outputs 2D range image - Applies to: blaze
        DeviceScanType_Linescan,  //!< The camera has a line scan sensor - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB and dart MIPI
    ...
    {
        DeviceTLType_CoaXPress,  //!< The device provides a CoaXPress transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        DeviceTLType_Custom,  //!< The device provides a custom transport layer - Applies to: dart MIPI
        DeviceTLType_GigEVision,  //!< The device provides a GigE Vision transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        DeviceTLType_USB3Vision  //!< The device provides a USB3 Vision transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    };
    ...
    enum DeviceTemperatureSelectorEnums
    {
        ...
        DeviceTemperatureSelector_Coreboard,  //!< The temperature is measured on the core board - Applies to: CamEmu, ace 2 GigE, ace 2 USB and ace USB
        ...
        DeviceTemperatureSelector_Sensor,  //!< The temperature is measured on the image sensor - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    ...
    enum EventNotificationEnums
    {
        ...
        EventNotification_Off,  //!< Event notifications are disabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        EventNotification_On,  //!< Event notifications are enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        EventNotification_Once  //!< Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
    };
    ...
    enum EventSelectorEnums
    {
        ...
        EventSelector_ExposureEnd,  //!< Event notifications for the Exposure End event can be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        EventSelector_FrameStart,  //!< Event notifications for the Frame Start event can be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        EventSelector_FrameTriggerMissed,  //!< Event notifications for the Frame Trigger Missed event can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        EventSelector_Overrun,  //!< Event notifications for the Overrun event can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        EventSelector_TemperatureStatusChanged,  //!< Event notifications for the Temperature Status Changed event can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        EventSelector_Test,  //!< Event notifications for the Test event can be enabled - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
    ...
    {
        EventTemperatureStatusChangedStatus_Critical,  //!< The temperature status changed to Critical - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        EventTemperatureStatusChangedStatus_Error,  //!< The temperature status changed to Error - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        EventTemperatureStatusChangedStatus_Ok  //!< The temperature status changed to Ok - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
    };
    ...
    {
        ExposureAuto_Continuous,  //!< The exposure time is adjusted continuously while images are being acquired - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ExposureAuto_Off,  //!< Automatic exposure time adjustment is disabled - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ExposureAuto_Once  //!< The exposure time is adjusted automatically to reach the specified target value - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    enum ExposureModeEnums
    {
        ...
        ExposureMode_Timed,  //!< The exposure mode is set to Timed - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ExposureMode_TriggerControlled,  //!< The exposure mode is set to Trigger Controlled - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ExposureMode_TriggerWidth  //!< The exposure mode is set to Trigger Width - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    };
    ...
    enum GainAutoEnums
    {
        GainAuto_Continuous,  //!< The gain is adjusted continuously while images are being acquired - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        GainAuto_Off,  //!< Automatic gain adjustment is disabled - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        GainAuto_Once  //!< The gain is adjusted automatically to reach the specifed target value - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };

    //! Valid values for GainSelector
    enum GainSelectorEnums
    {
        GainSelector_All,  //!< Changes to the gain will be applied universally - Applies to: CameraLink, GigE, ace USB, dart USB and pulse USB
    ...
    enum LineModeEnums
    {
        LineMode_InOut,  //!< The selected physical line can be used to input and output an electrical signal - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        LineMode_Input,  //!< The selected physical line can be used to input an electrical signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineMode_Output  //!< The selected physical line can be used to output an electrical signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    };
    ...
    enum LineSelectorEnums
    {
        ...
        LineSelector_Line1,  //!< Line 1 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSelector_Line2,  //!< Line 2 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSelector_Line3,  //!< Line 3 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
    ...
    {
        LineSource_AcquisitionActive,  //!< The source signal for the currently selected line is set to Acquisition Active - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        LineSource_Counter1Active,  //!< The source signal for the currently selected line is set to Counter 1 Active - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        LineSource_Counter2Active,  //!< The source signal for the currently selected line is set to Counter 2 Active - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        LineSource_ExposureActive,  //!< The source signal for the currently selected line is set to Exposure Active - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSource_ExposureTriggerWait,  //!< The source signal for the currently selected line is set to Exposure Trigger Wait - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        LineSource_FlashWindow,  //!< The source signal for the currently selected line is set to Flash Window - Applies to: CameraLink, GigE, ace USB and dart USB
        LineSource_FrameBurstActive,  //!< The source signal for the currently selected line is set to Frame Burst Active - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        LineSource_FrameBurstTriggerWait,  //!< The source signal for the currently selected line is set to Frame Burst Trigger Wait - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        LineSource_FrameTriggerWait,  //!< The source signal for the currently selected line is set to Frame Trigger Wait - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        LineSource_Off,  //!< No source signal is set for the currently selected line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        LineSource_Timer1Active,  //!< The source signal for the currently selected line is set to Timer 1 Active - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        LineSource_Timer2Active,  //!< The source signal for the currently selected line is set to Timer 2 Active - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        LineSource_UserOutput1,  //!< The source signal for the currently selected line is set to User Output 1 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSource_UserOutput2,  //!< The source signal for the currently selected line is set to User Output 2 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSource_UserOutput3,  //!< The source signal for the currently selected line is set to User Output 3 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    ...
    enum PixelFormatEnums
    {
        ...
        PixelFormat_BayerBG10,  //!< The pixel format is set to Bayer BG 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerBG12,  //!< The pixel format is set to Bayer BG 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerBG8,  //!< The pixel format is set to Bayer BG 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGB10,  //!< The pixel format is set to Bayer GB 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerGB12,  //!< The pixel format is set to Bayer GB 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerGB8,  //!< The pixel format is set to Bayer GB 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGR10,  //!< The pixel format is set to Bayer GR 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerGR12,  //!< The pixel format is set to Bayer GR 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerGR8,  //!< The pixel format is set to Bayer GR 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerRG10,  //!< The pixel format is set to Bayer RG 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerRG12,  //!< The pixel format is set to Bayer RG 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerRG8,  //!< The pixel format is set to Bayer RG 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_Mono10,  //!< The pixel format is set to Mono 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_Mono12,  //!< The pixel format is set to Mono 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_Mono8,  //!< The pixel format is set to Mono 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_RGB8,  //!< The pixel format is set to RGB 8 - Applies to: ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_YUV422_8,  //!< The pixel format is set to YUV 4:2:2 8 bit packed - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    ...
    enum PixelSizeEnums
    {
        ...
        PixelSize_Bpp10,  //!< The pixel depth in the acquired images is 10 bits per pixel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        PixelSize_Bpp12,  //!< The pixel depth in the acquired images is 12 bits per pixel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        PixelSize_Bpp14,  //!< The pixel depth in the acquired images is 14 bits per pixel - Applies to: CameraLink and GigE
        PixelSize_Bpp16,  //!< The pixel depth in the acquired images is 16 bits per pixel - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelSize_Bpp2,  //!< The pixel depth in the acquired images is 2 bits per pixel - Applies to: CameraLink, GigE and ace USB
        PixelSize_Bpp24,  //!< The pixel depth in the acquired images is 24 bits per pixel - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelSize_Bpp8  //!< The pixel depth in the acquired images is 8 bits per pixel - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    {
        SensorShutterMode_Global,  //!< The shutter opens and closes at the same time for all pixels - Applies to: dart USB and pulse USB
    ...
    {
        TestPattern_Black,  //!< The camera generates a black test pattern - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        TestPattern_Off,  //!< No test pattern is generated - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        TestPattern_Testimage1,  //!< The camera generates a test image with the test image 1 pattern - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        TestPattern_Testimage2,  //!< The camera generates a test image with the test image 2 pattern - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        TestPattern_Testimage3,  //!< The camera generates a test image with the test image 3 pattern - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        TestPattern_White  //!< The camera generates a white test pattern - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
    };
    ...
    {
        TriggerActivation_AnyEdge,  //!< The selected trigger is activated by the falling or rising edge of the source signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        TriggerActivation_FallingEdge,  //!< The selected trigger is activated by the falling edge of the source signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI and dart USB
        TriggerActivation_LevelHigh,  //!< The selected trigger is activated when the source signal is high - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        TriggerActivation_LevelLow,  //!< The selected trigger is activated when the source signal is low - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        TriggerActivation_RisingEdge  //!< The selected trigger is activated by the rising edge of the source signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    {
        TriggerMode_Off,  //!< The currently selected trigger is turned off - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        TriggerMode_On  //!< The currently selected trigger is turned on - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    enum TriggerSelectorEnums
    {
        ...
        TriggerSelector_ExposureActive,  //!< The Exposure Active trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_ExposureEnd,  //!< The Exposure End trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_ExposureStart,  //!< The Exposure Start trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_FrameActive,  //!< The Frame Active trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_FrameBurstActive,  //!< The Frame Burst Active trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_FrameBurstEnd,  //!< The Frame Burst End trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_FrameBurstStart,  //!< The Frame Burst Start trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        TriggerSelector_FrameEnd,  //!< The Frame End trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSelector_FrameStart,  //!< The Frame Start trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    enum TriggerSourceEnums
    {
        ...
        TriggerSource_Counter1Active,  //!< The Counter 1 Active trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Counter1End,  //!< The Counter 1 End trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Counter1Start,  //!< The Counter 1 Start trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Counter2Active,  //!< The Counter 2 Active trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Counter2End,  //!< The Counter 2 End trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Counter2Start,  //!< The Counter 2 Start trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        TriggerSource_Line1,  //!< The source signal for the selected trigger is set to Line 1 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        TriggerSource_Line2,  //!< The source signal for the selected trigger is set to Line 2 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        TriggerSource_Line3,  //!< The source signal for the selected trigger is set to Line 3 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        TriggerSource_Software,  //!< The source signal for the selected trigger is set to software triggering - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        TriggerSource_SoftwareSignal1,  //!< The source signal for the selected trigger is set to software signal 1 - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        TriggerSource_SoftwareSignal2,  //!< The source signal for the selected trigger is set to software signal 2 - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        TriggerSource_SoftwareSignal3,  //!< The source signal for the selected trigger is set to software signal 3 - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        TriggerSource_Timer1Active,  //!< The Timer 1 Active trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Timer1End,  //!< The Timer 1 End trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        TriggerSource_Timer2Active,  //!< The Timer 2 Active trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        TriggerSource_Timer2End,  //!< The Timer 2 End trigger can be configured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
    ...
    enum UserOutputSelectorEnums
    {
        ...
        UserOutputSelector_UserOutput1,  //!< The user-settable output signal 1 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        UserOutputSelector_UserOutput2,  //!< The user-settable output signal 2 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        UserOutputSelector_UserOutput3,  //!< The user-settable output signal 3 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
    ...
    enum UserSetDefaultEnums
    {
        ...
        UserSetDefault_Default,  //!< The Default User Set factory set is set as the default startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        UserSetDefault_UserSet1,  //!< User set 1 is set as the default startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        UserSetDefault_UserSet2,  //!< User set 2 is set as the default startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        UserSetDefault_UserSet3  //!< User set 3 is set as the default startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    enum UserSetSelectorEnums
    {
        ...
        UserSetSelector_Default,  //!< The Default User Set factory set can be loaded - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        UserSetSelector_UserSet1,  //!< User set 1 can be saved, loaded, or configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        UserSetSelector_UserSet2,  //!< User set 2 can be saved, loaded, or configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        UserSetSelector_UserSet3  //!< User set 3 can be saved, loaded, or configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition frame rate of the camera in frames per second - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables setting the camera's acquisition frame rate to a specified value - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the image acquisition mode - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Starts the acquisition of images - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Stops the acquisition of images - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how gain and exposure time will be balanced when the camera is making automatic adjustments - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the auto function ROI (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the auto function ROI from the left side of the sensor (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset from the top of the sensor to the auto function ROI (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which auto function ROI can be configured - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Gain Auto and the Exposure Auto auto functions to the currently selected auto function ROI - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Balance White Auto auto function to the currently selected auto function ROI - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the auto function ROI (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Gain parameter when the Gain Auto auto function is active - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Gain parameter when the Gain Auto auto function is active - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Target brightness for the Gain Auto and the Exposure Auto auto functions - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color channel can be adjusted when performing manual white balance - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Balance White Auto auto function - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent horizontal pixels to be summed - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for horizontal binning - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether sensor or FPGA binning can be configured - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent vertical pixels to be summed - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for vertical binning - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which sensor tap can be configured - Applies to: CameraLink, GigE, ace USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Configures black level compensation - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Brightness value to be applied - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image horizontally - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image vertically - Applies to: CamEmu, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the color space for image acquisitions - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Contrast value to be applied - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the contrast mode - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Current exposure time of the camera in microseconds - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure start delay with current settings - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the light source preset - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the connection signal for the currently selected line - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Delay to be applied to the periodic signal in microseconds - Applies to: ace 2 GigE and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the periodic signal channel to be configured - Applies to: ace 2 GigE and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source for synchronizing the periodic signal - Applies to: ace 2 GigE and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation value to be applied - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Scaling factor to be applied to all images - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power off - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power on - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Puts the sensor in standby mode - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the current power state of the sensor - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the transmitting FIFO is empty - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the transmitting FIFO has overflown - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sharpening value to be applied - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the maximum temperature the camera reached during operation - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the temperature state - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates how often the temperature state changed to Error - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bit depth used for internal image processing   - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the transfer bit depth mode - Applies to: boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bit rate for TWI communication - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Pulls SCL low, which is rarely needed - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Pulls SDA low, which is rarely needed - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Triggers a read transfer - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Address of the target device - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Buffer that holds data to be written or data that was read - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes to be transferred from or to the transfer buffer - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of an accepted read or write transfer - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Triggers an update of the transfer status - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Triggers a write transfer - Applies to: dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates how power is supplied to the device - Applies to: ace 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Includes the currently selected chunk in the payload data - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief AOI height of the acquired image - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the chunk mode - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief X offset of the AOI of the acquired image - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Y offset of the AOI of the acquired image - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum possible pixel value in the acquired image - Applies to: ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum possible pixel value in the acquired image - Applies to: ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the pixel format of the acquired image - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which chunk can be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes of data between the beginning of one line in the acquired image and the beginning of the next line in the acquired image - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the AOI of the acquired image - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the character set used by the strings of the device's bootstrap registers - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Disables feature streaming on the device - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Enables feature streaming on the device - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera's firmware - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Major version of the GenCP protocol supported by the device - Applies to: ace 2 USB, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version of the GenCP protocol supported by the device - Applies to: ace 2 USB, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the behavior of the camera's status LED - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Speed of transmission negotiated on the selected link - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Bandwidth limit for data transmission (in bytes per second) - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables/disables the device link throughput limit - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the schema file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the schema file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Additional information from the vendor about the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera model - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Endianness of the registers of the device - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Announces the end of feature streaming - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Prepares the camera for feature streaming - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Immediately resets and restarts the camera - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the SFNC specification that the camera is compatible with - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the SFNC specification that the camera is compatible with - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the SFNC specification that the camera is compatible with - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the scan type of the camera's sensor (area or line scan) - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Serial number of the camera - Applies to: ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the type of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the location in the camera where the temperature will be measured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief User-settable ID of the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera vendor - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Digital shift to be applied - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Exposure End event - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Exposure End event - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Exposure End event - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Trigger Missed event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Trigger Missed event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables event notifications for the currently selected event - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Event Overrun event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Event Overrun event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the event notification to be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Temperature Status Changed event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief New temperature status that applies after the Temperature Status Changed event was raised - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Temperature Status Changed event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Test event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the test event - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Exposure Auto auto function - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure mode - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera in microseconds - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the currently selected gain in dB - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Gain Auto auto function - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the gain type to be adjusted - Applies to: CameraLink, GigE, ace USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Gamma correction to be applied - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the Extended ID mode for GVSP - Applies to: GigE and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum height of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the electrical configuration of the currently selected line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the signal inverter function for the currently selected input or output line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the selected line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the I/O line to be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the currently selected line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the current logical state of the selected line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Single bit field indicating the current logical state of all available line signals at time of polling - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the region of interest (area of interest) from the left side of the sensor (in pixels) - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset of the region of interest (area of interest) from the top of the sensor (in pixels) - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Size of the payload in bytes - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum possible pixel value that can be transferred from the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum possible pixel value that can be transferred from the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the format of the pixel data transmitted by the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the depth of the pixel values in the image (in bits per pixel) - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables horizontal mirroring of the image - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables vertical mirroring of the image - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
  ...
  errors causing planar surfaces to appear curved.
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the shutter mode of the camera - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a Test event that can be used for testing event notification - Applies to: ace 2 GigE, ace 2 USB and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test pattern to display - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Test pending acknowledge time in milliseconds - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will activate the selected trigger - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay time in microseconds - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the currently selected trigger - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the trigger type to be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a software trigger signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the selected trigger - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-settable output signal to be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected user-settable output line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to be used as the startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the selected set into the camera's volatile memory and makes it the active configuration set - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Saves the current active set as the selected user set - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to load, save, or configure - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum width of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
